export const Samples = {
  "K_Magnetic Drum THEMIS": {
    filename: "kick_earth_magnetic_drum.mp3",
    source_name: "THEMIS_earth",
    thumbnail_file: "THEMIS_earth.jpeg",
    description:
      "Using data from NASA's THEMIS mission, scientists have discovered that when the magnetopause -- the outer boundary of Earth's protective magnetic field -- is struck by a jet of plasma from the Sun, it vibrates like a drum. Waves echo back and forth along its surface, much like they do on top of a drumhead.",
    info_url: "https://www.youtube.com/watch?v=vR_QP8Nl5bQ",
  },
  "K_Star 808 Kepler KIC": {
  ...
  "K_Eagle Has Landed": {
    ...
    description:
      "“The Eagle has landed,” Armstrong said at 4:18 p.m. The Eagle was the name of the lunar lander. Armstrong became the first person to walk on the moon, followed 20 minutes later by Aldrin.",
    info_url:
      "https://www.nasa.gov/mission_pages/apollo/missions/apollo11.html",
  },
  "SN_Jupiter Magnetosphere Juno": {
  ...
  "HH1_Saturn Sounds Cassini": {
    ...
    info_url:
      "https://directory.eoportal.org/web/eoportal/satellite-missions/t/themis",
  },
  "HH1_Radar Echoes Titan Huygens": {
    name: "HH1_Radar Echoes Titan Huygens",
  ...
  // # Hats Open
  "HH2_Saturn Sounds Cassini": {
    name: "HH2_Saturn Sounds Cassini",
  ...
  "HH2_Eagle Has Landed": {
    name: "HH2_Eagle Has Landed",
  ...
  "M_Plasma 9 Voyager 1": {
    name: "M_Plasma 9 Voyager 1",
  ...
  // # One-Shots
  "OS_Whistler Mode 1 Parker": {
    name: "OS_Whistler Mode 1 Parker",
    filename: "one_shot_psp_whistler_mode_waves.mp3",
    source_name: "parker_solar_probe",
    thumbnail_file: "parker_solar_probe.jpeg",
    description:
      "One year and three trips around the Sun later, NASA's Parker Solar Probe heard some weird, sci-fi sounds from plasma within the solar wind -- and those sounds may answer unanswered questions about how the wind forms.",
    info_url: "https://www.youtube.com/watch?v=vR_QP8Nl5bQ",
  },
  "OS_Whistler Waves EMFISIS": {
    name: "OS_Whistler Waves EMFISIS",
  ...
  "OS_Langmuir Waves Parker": {
    name: "OS_Langmuir Waves Parker",
  ...
  "OS_Deep Space Hubble": {
    name: "OS_Deep Space Hubble",
  ...
  "G_Shields Up Cassini": {
    name: "G_Shields Up Cassini",
  ...
  "G_Passing Tempel 1 Stardust": {
    name: "G_Passing Tempel 1 Stardust",
    ...
    info_url:
      "https://solarsystem.nasa.gov/resources/331/stardust-swoops-by-tempel-1/",
  },
  "G_We Choose The Moon": {
    name: "G_We Choose The Moon",
    ...
    info_url:
      "https://airandspace.si.edu/stories/editorial/we-choose-go-moon-and-other-apollo-speeches",
  },
};
...
export const Kits = {
  "Andromeda%20Strain": {
    ...
    elements: {
      kick: {
        ...
        source_name: "kepler",
        sound_url: "./assets/samples/kick_kepler_star_808.mp3",
        thumbnail_url: "./assets/images/kepler.jpeg",
        description: "Kepler: Star KIC7671081B Light Curve Waves to Sound",
        info_url:
          "https://www.nasa.gov/mission_pages/kepler/overview/index.html",
      },
      snare: {
        name: "SN_Plasmasphere Polar",
        source_name: "nasa_polar",
        sound_url: "./assets/samples/snare_plasmaspheric_hiss.mp3",
        thumbnail_url: "./assets/images/nasa_polar.jpeg",
        description:
          "Plasmaspheric hiss waves as heard by NASA’s Polar mission as it passed around Earth.",
        info_url:
          "https://agupubs.onlinelibrary.wiley.com/doi/abs/10.1029/2021JA029644",
      },
      hh_closed: {
        name: "HH1_Radar Echoes Titan Huygens",
        source_name: "titan",
        sound_url: "./assets/samples/hat_radar_echoes_titan_surface.mp3",
        thumbnail_url: "./assets/images/titan.jpeg",
        description:
          "This recording was produced by converting into audible sounds some of the radar echoes received by Huygens during the last few kilometers of its descent onto Saturn's moon Titan. As the probe approaches the ground, both the pitch and intensity increase. Scientists will use intensity of the echoes to speculate about the nature of the surface.",
        info_url: "https://solarsystem.nasa.gov/missions/huygens/in-depth/",
      },
      hh_open: {
        ...
        source_name: "cassini_saturn_radio_emmisions",
        sound_url:
          "./assets/samples/hat_open_cassini_saturn_radio_emmisions_1.mp3",
        thumbnail_url: "./assets/images/saturn_radio_emmissions.jpeg",
        description:
          "New research from the up-close Grand Finale orbits of NASA’s Cassini mission shows a surprisingly powerful interaction of plasma waves moving from Saturn to its moon Enceladus. Researchers converted the recording of plasma waves into a “whooshing” audio file that we can hear -- in the same way a radio translates electromagnetic waves into music. Much like air or water, plasma (the fourth state of matter) generates waves to carry energy. The recording was captured by the Radio Plasma Wave Science (RPWS) instrument Sept. 2, 2017, two weeks before Cassini was deliberately plunged into the atmosphere of Saturn.",
      ...
      melody: {
        name: "M_Plasma 9 Voyager 1",
        source_name: "voyager_1",
        sound_url: "./assets/samples/melody_voyage_plasma_9.mp3",
        thumbnail_url: "./assets/images/voyager_1.jpeg",
        description:
          "Voyager 1's plasma wave instrument detected the vibrations of dense interstellar plasma, or ionized gas, from October to November 2012 and April to May 2013. This sound reproduces the amplitude and frequency of the plasma waves as 'heard' by Voyager 1.",
      ...
      texture: {
        name: "OS_Whistler Waves EMFISIS",
        source_name: "earth",
        sound_url: "./assets/samples/one_shot_whistler_waves.mp3",
        thumbnail_url: "./assets/images/EMFISIS_earth.jpeg",
        description:
          "Whistler waves as heard by the EMFISIS instrument aboard NASA’s Van Allen Probes as it passed around Earth.",
        info_url:
      ...
      one_shot_1: {
        ...
        source_name: "hubble_deep_space",
        sound_url:
          "./assets/samples/one_shot_sonification_of_hubble_deep_space.mp3",
        thumbnail_url: "./assets/images/sonification_of_hubble_deep_space.jpeg",
        description:
          "Space becomes 'sonified' in this visualization of a cluster of galaxies imaged by NASA's Hubble Space Telescope. Time flows left to right, and the frequency of sound changes from bottom to top, ranging from 30 to 1,000 hertz. Objects near the bottom of the image produce lower notes, while those near the top produce higher ones. Most of the visible specks are galaxies housing countless stars. A few individual stars shine brightly in the foreground. Stars and compact galaxies create short, clear tones, while sprawling spiral galaxies emit longer notes that change pitch. The higher density of galaxies near the center of the image — the heart of this galaxy cluster, known as RXC J0142.9+4438 — results in a swell of mid-range tones halfway through the video. Hubble's Advanced Camera for Surveys and Wide Field Camera 3 acquired this image on Aug. 13, 2018.",
      ...
      one_shot_2: {
        ...
        source_name: "tempel_1",
        sound_url:
          "./assets/samples/groove_stardust_passing_comet_temple_1.mp3",
        thumbnail_url: "./assets/images/tempel_1.jpeg",
        description: "Stardust: Passing Comet Tempel 1",
        info_url:
          "https://solarsystem.nasa.gov/resources/331/stardust-swoops-by-tempel-1/",
      },
  ...
  Magnetosphere: {
    ...
    elements: {
      kick: {
        name: "K_Magnetic Drum THEMIS",
        source_name: "THEMIS_earth",
        sound_url: "./assets/samples/kick_earth_magnetic_drum.mp3",
        thumbnail_url: "./assets/images/THEMIS_earth.jpeg",
        description:
          "Using data from NASA's THEMIS mission, scientists have discovered that when the magnetopause -- the outer boundary of Earth's protective magnetic field -- is struck by a jet of plasma from the Sun, it vibrates like a drum. Waves echo back and forth along its surface, much like they do on top of a drumhead.",
        info_url: "https://en.wikipedia.org/wiki/THEMIS",
      },
      snare: {
        name: "SN_Jupiter Magnetosphere Juno",
        source_name: "juno",
        sound_url:
          "./assets/samples/snare_juno_entering_jupiter_magnetosphere.mp3",
        thumbnail_url: "./assets/images/juno.jpeg",
        description:
          "Juno will improve our understanding of the solar system's beginnings by revealing the origin and evolution of Jupiter.",
        info_url: "https://www.jpl.nasa.gov/missions/juno",
      },
      hh_closed: {
        name: "HH1_Saturn Sounds Cassini",
        source_name: "cassini",
        sound_url:
          "./assets/samples/hat_closed_cassini_saturn_radio_emmisions.mp3",
        thumbnail_url: "./assets/images/cassini.jpeg",
        description:
          "Hear intriguing radio waves that our Cassini spacecraft collected near Jupiter in January 2001.",
        info_url:
          "https://directory.eoportal.org/web/eoportal/satellite-missions/t/themis",
      ...
      melody: {
        name: "M_Cold Helium",
        source_name: "earth",
        sound_url: "./assets/samples/melody_ultra_cold_helium.mp3",
        thumbnail_url: "./assets/images/ultra_cold_helium_3.jpeg",
        description:
          "If you're squeamish, you may not want to listen to the strange whistle of ultra-cold liquid helium-3 that changes volume relative to the North Pole and Earth's rotation. When ultra-cold liquid helium-4 was squashed through an array of tiny apertures, a phenomenon occurred in which the helium-4 repeatedly sped up, slowed down and vibrated. This produced a 'quantum whistle' -- a whistling sound that went from high to low.",
      ...
      texture: {
        name: "OS_Langmuir Waves Parker",
        source_name: "parker_solar_probe",
        sound_url: "./assets/samples/one_shot_psp_langmuir_waves.mp3",
        thumbnail_url: "./assets/images/parker_solar_probe.jpeg",
        description:
          "One year and three trips around the Sun later, NASA's Parker Solar Probe heard some weird, sci-fi sounds from plasma within the solar wind -- and those sounds may answer unanswered questions about how the wind forms.",
      ...
      one_shot_1: {
        name: "OS_Whistler Mode 1 Parker",
        source_name: "parker_solar_probe",
        sound_url: "./assets/samples/one_shot_psp_whistler_mode_waves.mp3",
        thumbnail_url: "./assets/images/parker_solar_probe.jpeg",
        description:
          "One year and three trips around the Sun later, NASA's Parker Solar Probe heard some weird, sci-fi sounds from plasma within the solar wind -- and those sounds may answer unanswered questions about how the wind forms.",
      ...
      one_shot_2: {
        name: "G_Shields Up Cassini",
        source_name: "cassini",
        sound_url: "./assets/samples/groove_cassini_shields_up.mp3",
        thumbnail_url: "./assets/images/cassini.jpeg",
        description:
          "Before settling into orbit around Saturn, Cassini faced a white-knuckle ride through the plane of the planet’s rings. When converted into an audio file, the interstellar cacophony is reminiscent of a hellstorm on Earth.",
        info_url: "https://solarsystem.nasa.gov/missions/cassini/overview/",
  ...
  "Apollo%2011": {
    ...
    elements: {
      kick: {
        name: "K_Eagle Has Landed",
        source_name: "apollo_11",
        sound_url: "./assets/samples/kick_eagle_has_landed.mp3",
        thumbnail_url: "./assets/images/apollo_astronaut.jpeg",
        description:
          "“The Eagle has landed,” Armstrong said at 4:18 p.m. The Eagle was the name of the lunar lander. Armstrong became the first person to walk on the moon, followed 20 minutes later by Aldrin.",
        info_url:
          "https://www.nasa.gov/mission_pages/apollo/missions/apollo11.html",
      ...
      snare: {
        name: "SN_One Small Step",
        source_name: "apollo_11_armstrong",
        sound_url: "./assets/samples/snare_small_step.mp3",
        thumbnail_url: "./assets/images/one_small_step.jpeg",
        description:
          "The Eagle lunar lander, carrying Armstrong and Aldrin, landed on the Sea of Tranquility on July 20, 1969. Armstrong was the first one out, proclaiming for the ages: “That's one small step for man, one giant leap for mankind.”",
        info_url: "https://www.nasa.gov/mission_pages/apollo/apollo11.html",
      },
      hh_closed: {
        name: "HH1_Eagle Has Landed",
        source_name: "apollo_11",
        sound_url: "./assets/samples/hh_closed_eagle_has_landed.mp3",
        thumbnail_url: "./assets/images/apollo_astronaut.jpeg",
        description:
          "“The Eagle has landed,” Armstrong said at 4:18 p.m. The Eagle was the name of the lunar lander. Armstrong became the first person to walk on the moon, followed 20 minutes later by Aldrin.",
        info_url:
      ...
      hh_open: {
        name: "HH2_Eagle Has Landed",
        source_name: "apollo_11",
        sound_url: "./assets/samples/hh_open_eagle_has_landed.mp3",
        thumbnail_url: "./assets/images/apollo_astronaut.jpeg",
        description:
          "“The Eagle has landed,” Armstrong said at 4:18 p.m. The Eagle was the name of the lunar lander. Armstrong became the first person to walk on the moon, followed 20 minutes later by Aldrin.",
        info_url: "https://www.nasa.gov/mission_pages/apollo/apollo11.html",
      ...
      melody: {
        name: "OS_Eagle Has Landed",
        source_name: "apollo_11",
        sound_url: "./assets/samples/one_shot_eagle_has_landed.mp3",
        thumbnail_url: "./assets/images/apollo_astronaut.jpeg",
        description:
          "“The Eagle has landed,” Armstrong said at 4:18 p.m. The Eagle was the name of the lunar lander. Armstrong became the first person to walk on the moon, followed 20 minutes later by Aldrin.",
        info_url:
      ...
      texture: {
        name: "OS_One Small Step",
        source_name: "apollo_11_armstrong",
        sound_url: "./assets/samples/one_shot_one_small_step.mp3",
        thumbnail_url: "./assets/images/one_small_step.jpeg",
        description:
          "The Eagle lunar lander, carrying Armstrong and Aldrin, landed on the Sea of Tranquility on July 20, 1969. Armstrong was the first one out, proclaiming for the ages: “That's one small step for man, one giant leap for mankind.”",
        info_url: "https://www.nasa.gov/mission_pages/apollo/apollo11.html",
      ...
      one_shot_1: {
        name: "OS_One Giant Leap",
        source_name: "apollo_11_armstrong",
        sound_url: "./assets/samples/one_shot_one_giant_leap.mp3",
        thumbnail_url: "./assets/images/one_small_step.jpeg",
        description:
          "The Eagle lunar lander, carrying Armstrong and Aldrin, landed on the Sea of Tranquility on July 20, 1969. Armstrong was the first one out, proclaiming for the ages: “That's one small step for man, one giant leap for mankind.”",
        info_url: "https://www.nasa.gov/mission_pages/apollo/apollo11.html",
      ...
      one_shot_2: {
        name: "G_We Choose The Moon",
        source_name: "kennedy_apollo_11",
        sound_url: "./assets/samples/groove_jfk_wechoosethemoonspeech.mp3",
        thumbnail_url: "./assets/images/president_kennedy.jpeg",
        description:
          "“We choose to go to the Moon”, officially titled the Address at Rice University on the Nation's Space Effort, is a September 12, 1962, speech by United States President John F. Kennedy to further inform the public about his plan to land a man on the Moon before 1970.",
        info_url:
          "https://airandspace.si.edu/stories/editorial/we-choose-go-moon-and-other-apollo-speeches",
